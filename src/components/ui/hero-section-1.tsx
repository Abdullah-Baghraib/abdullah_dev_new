...
import { ArrowRight, ChevronRight, Menu, X, Github, Linkedin, Twitter, Mail } from 'lucide-react'
    ...
    return (
        <>
            ...
            <main className="overflow-hidden">
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    ...
                                    <div className="flex justify-center gap-6 mt-6">
                                        <a href="https://github.com/Abdullah-Baghraib" className="text-muted-foreground hover:text-foreground transition-colors">
                                            <Github size={24} />
                                        </a>
                                        <a href="https://www.linkedin.com/in/abdullah-baghrib/" className="text-muted-foreground hover:text-foreground transition-colors">
                                            <Linkedin size={24} />
                                        </a>
                                        <a href="https://x.com/ms1ms33__" className="text-muted-foreground hover:text-foreground transition-colors">
                                            <Twitter size={24} />
                                        </a>
                                        <a href="mailto:abdullahbaghraib@gmail.com" className="text-muted-foreground hover:text-foreground transition-colors">
                                            <Mail size={24} />
                                        </a>
                                    </div>
                                </AnimatedGroup>
                ...
                {/* Removing the business logos section */}
            </main>
        </>
    )
}
                    ...
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full justify-between lg:w-auto">
                            <a
                                ...
                                <span className="font-bold text-lg">Abdulla.dev</span>
                            </a>
